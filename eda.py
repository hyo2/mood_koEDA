...
wordnet = {}
with open("C:/Users/Hi/PycharmProjects/mood_KoEDA/wordnet.pickle", "rb") as f:
    wordnet = pickle.load(f)


# '/ ^[ㄱ-ㅎㅏ-ㅣ가-힣]*$/'
# 띄어쓰기와 맞춤법을 교정한 한글 문장 리턴
def get_only_hangul(line):
    parseText = re.compile('[^ \u3131-\u3163\uac00-\ud7a3]+').sub('', line)# 한글만 남기고 나머지는 삭제(한글과 띄어쓰기를 제외한 모든 부분을 제거)
